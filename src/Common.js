...
const Common = (props) => {
    ...
    return (
        <>
            <div>
                <section id="header" className="d-grid align-items-center" style={{ overflow: 'scroll' }}>
                    <div className="container-fluid ">
                        <div className="row">
                            <div className="col-12 mx-auto">
                                
                                <div className="row">
                                    <div className="col-md-12 pt-5 pt-lg-0 order order-lg-1 d-flex justify-content-center flex-column"><br />
                                        ...
                                        <p>This app-based source is revolutionary in that it aggregates articles from various publications to bring you the need-to-know information on numerous stories. Constantly updating, Circa is a valuable tool for developing stories.</p>
                                        <p>&nbsp;</p>
